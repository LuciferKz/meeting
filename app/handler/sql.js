module.exports = {
    ...
    SQL_USER_LIST: 'SELECT `user`.id, `user`.username, `brand`.name as brandName, `user`.createAt, `user`.updateAt FROM user LEFT JOIN brand ON user.brand_id = brand.id LIMIT ?,?',
